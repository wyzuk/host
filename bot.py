...
async def on_message(message):
    ...
    if cid in nano_sessions:
        ...
        if t_num:
            with open(f"term{t_num}/{nano_sessions[cid]}", 'w') as f: 
    ...
    if cid in TERMINALS:
        ...
        try:
            ...
            if args[0] == "ls":
                ...
                await message.channel.send(f"🚀 **Son Bot Online in T-{t_num}...**")
...
@bot.event
async def on_ready():
    print(f"Nebula V5.7 Online. Cluster Ready.")
